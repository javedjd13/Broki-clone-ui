...
const Listing = () => {
  ...
  return (
    <div className="p-4 sm:p-6 bg-white min-h-screen font-sans">
      ...
      >
        <motion.div
          className="ml-at-1440 lg:ml-44 px-6 max-w-[1200px]"
        ...
        {/* Layout wrapper */}
        <div className="listing-layout-md-exact px-6 max-w-[1200px] mx-auto row gx-xl-5">
          {/* Sidebar */}
          <motion.div
            className="listing-form px-6 min-w-[370px] col-lg-4 d-none d-lg-block"
          ...
          {/* Listings */}
          <motion.section className="w-full" variants={containerVariants}>
            {/* Top bar */}
            <motion.div
              className="flex flex-col sm:flex-row justify-between items-start sm:items-center mt-5 ml-10 mb-4 gap-2 sm:gap-0"
              variants={itemVariants}
            >
              <p className="text-sm text-gray-500">
                Showing {indexOfFirst + 1}–
